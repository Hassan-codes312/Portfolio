  ...
  const projects = [
    {
      ...
      link: 'https://your-calculator-link.netlify.app', // Replace with your actual link
      status: 'completed'
    },
    {
      name: 'React Weather APP',
      description: 'Weather application using React and external API integration',
      link: 'https://your-weather-app-link.netlify.app', // Replace with your actual link
      status: 'completed'
    },
    {
      name: 'Netflix Clone',
      description: 'Netflix UI clone with React Router and movie API',
      link: 'https://your-netflix-clone-link.netlify.app', // Replace with your actual link
      status: 'completed'
    },
    {
      name: 'PDF Converter (CONVERT CRAFT)',
      description: 'Web application for converting documents to PDF format',
      link: 'https://your-pdf-converter-link.netlify.app', // Replace with your actual link
      status: 'completed'
    },
    {
      name: 'Javascript To-do List',
      description: 'Task management application with local storage',
      link: 'https://your-todo-list-link.netlify.app', // Replace with your actual link
      status: 'completed'
    },
    {
      name: 'CLIPVIBE',
